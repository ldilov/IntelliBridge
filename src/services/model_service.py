...
class ModelService(object):
    def __init__(self, args):
        ...
        if self.args.deepspeed:
            from src.data_processing.loader.deepspeed_loader import DeepSpeedLoader
            ...
            from src.data_processing.loader.llamacpp_loader import LlamaCppLoader
            ...
            if self.args.monkey_patch:
                from src.data_processing.loader.loader_4bit_helper import load_model_llama_4bit
                loader = type('', (object,), {"load": lambda: load_model_llama_4bit(self.args, gptq_loader)})()
            else:
                loader = gptq_loader
        else:
            from src.data_processing.loader.full_precision_loader import FullPrecisionLoader
