...
try:
    ...
    os.add_dll_directory(pathlib.Path(torch.__file__).parent / "lib")
    import quant_cuda
except:
...
class QuantLinear(nn.Module):
    def __init__(self, bits, groupsize, infeatures, outfeatures):
        ...
        self.register_buffer('qzeros', torch.zeros((math.ceil(infeatures / groupsize), outfeatures // 256 * (bits * 8)),
                                                   dtype=torch.int))
