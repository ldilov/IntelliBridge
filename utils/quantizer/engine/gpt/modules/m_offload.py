...
class MOffload(GPTJModel):
    """
    CPU Offloaded nn.Module, wrapping around GPTJModel
    """
    ...
    def forward(
        ...
        batch_size, seq_length, seq_length_with_past, past_key_values_length = self._prepare_inputs(input_ids, inputs_embeds, past_key_values)
    ...
    def _prepare_inputs(self, input_ids, inputs_embeds, past_key_values):
        ...
        return batch_size, seq_length_with_past, seq_length_with_past, past_key_values_length
